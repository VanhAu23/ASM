import { getAll, remove, add, update } from "../../api/Project"
import { useEffect, useState } from "../../lib"

const ProjectManegementPage = () => {
    ...
    <div id="layoutSidenav">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link collapsed" href="/admin/project/add" data-bs-toggle="collapse"
        ...
        return `
          <tr>
           ...
           <td> <img src="${project.image}" width='150' height='100'><td>
            <td>${project.url}</td>
    ...
    <script src="src/chart-area-demo.js"></script>
    <script src="src/demo/chart-bar-demo.js"></script>
...
export default ProjectManegementPage
